document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Konsultasi Dokter Modal Handling ---
    // Get the modal
    var modal = document.getElementById("konsultasiModal");

    // Get the button that opens the modal
    var btn = document.getElementById("consultationButton");
    ...
    // --- End Konsultasi Dokter Modal Handling ---
